...
private struct ElementCache(R)
{
    ...
    Stats stats() const @nogc pure @safe scope
    {
        Stats result = stats_;
    ...
    bool isValidId_(in size_t id) const @nogc pure @safe scope
    {
    ...
    void popFrontOf(in size_t id) @nogc pure @safe scope
    in (isValidId_(id), mixin (idError_))
    {
    ...
    static if (rangeHasLength)
    {
        ...
        auto lengthOf(in size_t id) @nogc pure @safe scope
        in (isValidId_(id), mixin (idError_))
        {
    ...
    // (used) by any slice
    size_t unreferencedLeadingElements() @nogc pure @safe scope
    {
    ...
    void dropLeadingElements(size_t n) @nogc pure @safe scope
    {
...
public:
    ...
    */
    ...
    void popFront() @nogc pure @safe scope
    {
    ...
    */
    ...
    static if (EC.rangeHasLength)
    {
        ...
        */
        auto length() @nogc pure @safe scope
        {
